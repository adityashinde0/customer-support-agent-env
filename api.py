...
def home():
    ...
    <head>
        ...
        <style>
            ...
            .docs-btn { background-color: #228B22; color: white; padding: 8px 16px; text-decoration: none; border-radius: 6px; font-size: 14px; font-weight: bold; transition: 0.2s; }
            .docs-btn:hover { background-color: #006400; }
